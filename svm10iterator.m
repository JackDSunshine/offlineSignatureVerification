...
TAR10s=(true/190)*100;
FRR10s=(truef/190)*100;
TRR10s=(false/190)*100;
FAR10s=(falsef/190)*100;
...
hold on;
text(10,10,'TAR:')
text(50,10,num2str(TAR10s))
text(10,50,'FRR:')
 text(50,50,num2str(FRR10s))
 text(10,90,'TRR:')
text(50,90,num2str(TRR10s))
 text(10,130,'FAR:')
text(50,130,num2str(FAR10s))
% saving the result
save('result10svm.mat','A3','TAR10s','FRR10s','TRR10s','FAR10s');
