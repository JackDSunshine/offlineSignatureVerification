...
% here we take 5 genuine and 5 forgeries to train using svm
load feature.mat;
clc;
train7=cell(2,20);
j=1;
...
train7(2,1)={0};train7(2,2)={0};train7(2,3)={0};train7(2,4)={0};train7(2,5)={0};train7(2,6)={1};train7(2,7)={1};train7(2,8)={1};train7(2,9)={1};train7(2,10)={1};
